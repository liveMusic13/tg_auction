...
// 	// Функция для увеличения/уменьшения масштаба
// 	const handleZoom = direction => {
// 		setScale(prevScale => {
// 			if (direction === 'in') {
// 				return Math.min(prevScale + 0.2, 3); // Максимальный масштаб 3
// 			} else {
// 				return Math.max(prevScale - 0.2, 1); // Минимальный масштаб 1
// 			}
// 		});
// 	};
...
// 		onSwipedUp: () => handleZoom('in'), // Свайп вверх увеличивает
// 		onSwipedDown: () => handleZoom('out'), // Свайп вниз уменьшает
...
// 						transition: 'transform 0.3s ease-in-out', // Плавная анимация изменения масштаба
// 					}}
// 				>
// 					<img
// 						className={styles.fullScreenImage}
...
const Galery = ({ lot }) => {
	...
	const handlers = useSwipeable({
		...
		delta: 10, // Чувствительность к свайпу
	});
